...
# Download Hive
RUN curl -s http://archive.apache.org/dist/hive/hive-2.3.3/apache-hive-2.3.3-bin.tar.gz | tar -xz -C /opt
# RUN curl -s https://jdbc.postgresql.org/download/postgresql-9.4.1212.jar -O /opt/apache-hive-2.3.3-bin/lib/postgresql-jdbc.jar
RUN cd /opt && ln -s ./apache-hive-2.3.3-bin hive
